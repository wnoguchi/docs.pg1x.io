...
.. code-block:: text
   ...
   ip 172.16.1.11 255.255.255.0 172.16.1.10
   save
...
.. code-block:: text
   ...
   ip 172.16.2.12 255.255.255.0 172.16.2.10
   save
...
.. code-block:: text
   ...
   ip 10.1.1.23 255.255.255.0 10.1.1.2
   save
...
.. code-block:: text
   ...
   ip 10.2.1.44 255.255.255.0 10.2.1.4
   save
...
#. 外部エリアへの通信はすべてデフォルトルートを通して行われる
#. LSA タイプ 1, 2 のみ流れることを許可
#. つまり LSA タイプ 3 もブロックする
#. トータリースタブエリアは Cisco 独自の機能
...
.. code-block:: shell-session
   ...
   C       10.1.2.0 is directly connected, FastEthernet0/1
   C       10.2.34.0 is directly connected, Serial0/0
   O*IA 0.0.0.0/0 [110/65] via 10.2.34.3, 00:00:08, Serial0/0
...
.. code-block:: shell-session
   ...
   Link ID         ADV Router      Age         Seq#       Checksum Link count
   10.2.34.3       10.2.34.3       857         0x80000003 0x009916 2
   10.2.34.4       10.2.34.4       856         0x80000005 0x00FA63 4
   
                   Summary Net Link States (Area 1)
   
   Link ID         ADV Router      Age         Seq#       Checksum
   0.0.0.0         10.2.34.3       35          0x80000002 0x0044C7

==================================================================
NSSA(Not So Stubby Area)
==================================================================

直訳すれば「それほどにスタブじゃないルーター」。
つまり
