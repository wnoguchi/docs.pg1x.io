...
PC と PC をつなげるだけのかんたんなお仕事
---------------------------------------------------------

.. image:: img/2017-02-26_11h54_07-simple-pc-topology.png
...
ターミナルを立ち上げて（デフォルトは putty です。というか世界標準は putty です）以下を入力すると PC に IP が設定される。
便利ー。
...
.. image:: img/2017-02-26_11h58_11-vpc-ip-setting.png

ping も打ってみる。

.. image:: img/2017-02-26_12h00_45-ping.png
